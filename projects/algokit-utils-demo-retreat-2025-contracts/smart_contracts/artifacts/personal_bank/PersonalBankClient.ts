...
export const APP_SPEC: Arc56Contract = {
  ...
  state: {
    ...
    maps: { global: {}, local: {}, box: { depositors: { keyType: 'AVMBytes', valueType: 'AVMUint64', prefix: '' } } },
  },
  bareActions: { create: ['NoOp'], call: [] },
  sourceInfo: {
    approval: {
      sourceInfo: [
        { pc: [111], errorMessage: 'Deposit amount must be greater than zero' },
        { pc: [162], errorMessage: 'No deposits found for this account' },
        { pc: [43, 60], errorMessage: 'OnCompletion is not NoOp' },
        { pc: [105], errorMessage: 'Receiver must be the contract address' },
        { pc: [92], errorMessage: 'can only call when creating' },
        { pc: [46, 63], errorMessage: 'can only call when not creating' },
        { pc: [130, 142], errorMessage: 'check self.depositors entry exists' },
        { pc: [73], errorMessage: 'transaction type is pay' },
      ],
      pcOffsetMethod: 'none',
    },
  ...
  byteCode: {
    approval:
      'CiACAQAmAQQVH3x1MRtBAEOCAgQymOfABDo5Xys2GgCOAgATAAIjQzEZFEQxGESIAGoWKExQsCJDMRkURDEYRDEWIglJOBAiEkSIABIWKExQsCJDMRlA/80xGBREIkOKAQGL/zgHMgoSRIv/OAhJRIv/OABJvkUBQQAXiwFJvkwXTESLAAgWv4sBvkwXTESMAImLABaLAUy/Qv/sMQC+TBdMRLExALIHsggishAjsgGztAgxACMWv4k=',
    clear: 'CoEBQw==',
  },
  compilerInfo: { compiler: 'puya', compilerVersion: { major: 4, minor: 6, patch: 1 } },
  events: [],
  templateVariables: {},
 ...
 */
export type PersonalBankNonVoidMethodSignatures = keyof PersonalBankTypes['methods'] extends infer T
  ? T extends keyof PersonalBankTypes['methods']
 ...
 */
export type MethodArgs<TSignature extends PersonalBankSignatures> = PersonalBankTypes['methods'][TSignature][
  | 'argsObj'
  | 'argsTuple']
/**
 * Maps a method signature from the PersonalBank smart contract to the method's return type
 */
export type MethodReturn<TSignature extends PersonalBankSignatures> =
  PersonalBankTypes['methods'][TSignature]['returns']
...
export abstract class PersonalBankParamsFactory {
  ...
  static deposit(
    params: CallParams<
      PersonalBankArgs['obj']['deposit(pay)uint64'] | PersonalBankArgs['tuple']['deposit(pay)uint64']
    > &
      CallOnComplete,
   ...
   */
  static withdraw(
    params: CallParams<PersonalBankArgs['obj']['withdraw()uint64'] | PersonalBankArgs['tuple']['withdraw()uint64']> &
      CallOnComplete,
  ): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
...
export class PersonalBankClient {
   ...
   */
  decodeReturnValue<TSignature extends PersonalBankNonVoidMethodSignatures>(
    method: TSignature,
   ...
   * @param params The parameters to create the app client
   */
  static async fromNetwork(params: Omit<ResolveAppClientByNetwork, 'appSpec'>): Promise<PersonalBankClient> {
  ...
  readonly params = {
    ...
    withdraw: (
      params: CallParams<
        PersonalBankArgs['obj']['withdraw()uint64'] | PersonalBankArgs['tuple']['withdraw()uint64']
    ...
    box: {
      ...
      depositors: {
        ...
        getMap: async (): Promise<Map<Uint8Array, bigint>> => {
          return (await this.appClient.state.box.getMap('depositors')) as Map<Uint8Array, bigint>
        },
        /**
         * Get a current value of the depositors map by key from box state
         */
        value: async (key: Uint8Array | string): Promise<bigint | undefined> => {
          return (await this.appClient.state.box.getMapValue('depositors', key)) as bigint | undefined
        },
      },
    },
  }
...
export type PersonalBankComposer<TReturns extends [...any[]] = []> = {
  ...
  deposit(
    params?: CallParams<
      PersonalBankArgs['obj']['deposit(pay)uint64'] | PersonalBankArgs['tuple']['deposit(pay)uint64']
    >,
  ): PersonalBankComposer<[...TReturns, PersonalBankReturns['deposit(pay)uint64'] | undefined]>
  ...
  withdraw(
    params?: CallParams<PersonalBankArgs['obj']['withdraw()uint64'] | PersonalBankArgs['tuple']['withdraw()uint64']>,
  ): PersonalBankComposer<[...TReturns, PersonalBankReturns['withdraw()uint64'] | undefined]>
  ...
  ): Promise<PersonalBankComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(
...
export type PersonalBankComposerResults<TReturns extends [...any[]]> = Expand<
  SendAtomicTransactionComposerResults & {
    returns: TReturns
  }
>
